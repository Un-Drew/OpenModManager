...
namespace ModdingTools.GUI
{
    public partial class ModTile : UserControl
    {
        ...
        static public CookedContentAnalysis BuildingAnalysis { get; protected set; } = null;

        private void analyzeCookedContentToolStripMenuItem_Click(object sender, EventArgs e)
        {
